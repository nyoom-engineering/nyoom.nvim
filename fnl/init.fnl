...
(opt- packer startup
      {1 (fn [use]
           ...
           (use-package {1 :tweekmonster/startuptime.vim :cmd :StartupTime}) ; profiling
           (use-package {1 :Olical/aniseed :branch :develop})
           ;; keybindings
